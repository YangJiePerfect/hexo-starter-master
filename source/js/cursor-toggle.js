...
(function () {
    ...
    function createButton () {
      var hide = document.getElementById('rightside-config-hide')
      if (!hide) return null
    ...
    function bindCursorToggle () {
      var button = document.getElementById('cursor-toggle') || createButton()
      if (!button || !window.TargetCursorController) return
